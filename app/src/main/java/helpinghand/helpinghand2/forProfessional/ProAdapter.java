                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    ddd.child("status").setValue("Accepted.");
                                    ...
                                    mBuilder.setContentText("Booking Accepted for " + currentBooking.getUsername());
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ddd.removeValue(new DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                        ...
                                        mBuilder.setSmallIcon(R.drawable.helpinghand);
                                        mBuilder.setContentTitle("Helping Hand Notification");
                                        mBuilder.setContentText("Booking Deleted for " + currentBooking.getUsername());

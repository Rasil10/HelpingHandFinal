...
//
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(SearchByNearest.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 101);
    ...
    private void showDetail(final Professional p) {
        ...
        call_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(SearchByNearest.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(SearchByNearest.this, new String[]{android.Manifest.permission.CALL_PHONE}, 101);
                    return;
                }

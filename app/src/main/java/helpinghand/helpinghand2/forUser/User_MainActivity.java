...
import helpinghand.helpinghand2.AboutUs;
import helpinghand.helpinghand2.LoginActivity;
import helpinghand.helpinghand2.MyIntro;
...
//            startActivity(i);
            Intent i = new Intent(User_MainActivity.this, MyIntro.class);
            startActivity(i);
            return true;
        } else if
                (id == R.id.menu_contact_us) {
            Intent i = new Intent(User_MainActivity.this, AboutUs.class);
            startActivity(i);
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main) {
            ...
            Intent i = new Intent(User_MainActivity.this, Notification.class);
            startActivity(i);

...
public class    MapsActivity_forUser extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final Professional professional=new Professional(professionalName,professionaladdress,professionalphone,professionalCategory
                                                        ,professionalLatitude,professionalLongitude);
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(MapsActivity_forUser.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 101);
